...
(cl:defmethod cl:initialize-instance :after ((m <Floats>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Floats)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rospy_tutorials-msg:<Floats> is deprecated: use rospy_tutorials-msg:Floats instead.")))
