...
(cl:in-package roscpp_tutorials-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <TwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp_tutorials-srv:<TwoInts-request> is deprecated: use roscpp_tutorials-srv:TwoInts-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <TwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp_tutorials-srv:a-val is deprecated.  Use roscpp_tutorials-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <TwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp_tutorials-srv:b-val is deprecated.  Use roscpp_tutorials-srv:b instead.")
  (b m))
...
(cl:defmethod cl:initialize-instance :after ((m <TwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp_tutorials-srv:<TwoInts-response> is deprecated: use roscpp_tutorials-srv:TwoInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <TwoInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp_tutorials-srv:sum-val is deprecated.  Use roscpp_tutorials-srv:sum instead.")
  (sum m))
